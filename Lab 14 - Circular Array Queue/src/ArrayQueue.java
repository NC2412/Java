...
public class ArrayQueue<E> extends AQueue<E> implements IQueue<E>{
    ...
    public boolean offer(E e) {
        if (added - removed >= maxSize)
        	return false;
        else {
        	elements[added % maxSize] = e;
    ...
    public E poll() {
    	if (added - removed <= 0)
	        ...
	        E remItem = elements[removed % maxSize];
	        elements[removed % maxSize] = null;
    ...
    public E peek() {
    	if (added == removed)
    		...
    		return elements[removed % maxSize];
    }
