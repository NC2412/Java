...
public class TestCases {
	...
	public void testNegativeGCD() {
		...
		assertEquals("Error: should return -1", -1, functions.greatestCommonDivisor(0, -10));
		assertEquals("Error: should return -1", -1, functions.greatestCommonDivisor(-10, 0));
		assertEquals("Error: should return -1", -1, functions.greatestCommonDivisor(-100, -100));
	}
	...
	@Test
	public void testGeneralInputGCD() {
		// General inputs
